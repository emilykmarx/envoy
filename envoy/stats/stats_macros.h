...
#define GENERATE_MAP_STRUCT(NAME) Envoy::Stats::Map& NAME##_;
...
#define POOL_MAP_PREFIX(POOL, PREFIX) (POOL).mapFromString(Envoy::statPrefixJoin(PREFIX, FINISH_STAT_DECL_
...
#define POOL_MAP(POOL) POOL_MAP_PREFIX(POOL, "")
